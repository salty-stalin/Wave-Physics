...
for t in np.arange(0,10,.02):
    plt.title('$t=$'+str(t))
    plt.subplot(311)
    aa=plt.plot(xxx,wave_real(xx,t,omega0,k0))
    plt.ylabel('$\\psi$',fontsize=15)
    plt.subplot(312)
    aa=plt.plot(xxx,wave_imaginary(xx,t,omega0,k0))
    plt.ylabel('$\\psi_*$',fontsize=15)
    plt.subplot(313)
    aa=plt.plot(xxx,wave_real(xx,t,omega0,k0)**2+wave_imaginary(xx,t,omega0,k0)**2)
